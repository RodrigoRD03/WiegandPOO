...
# 36 "c:\\Users\\Equipo 25\\Documents\\Arduino\\WiegandOOP\\WiegandPoo.ino"
...
void setup() {
    ...
    delay(1000);
    uint8_t entradas[] = { 16, 27 , 17, 5, 18, 19, 26, 25, 33, 32 };
    for(int i = 0; i < 10; i++){
        pinMode(entradas[i], 0x03);
        digitalWrite(entradas[i], 0x0);
    }
    preferences.begin("Beniplas", false);
    ...
    C2.definirSalidas(27, 26, 25, 33, 32);
}
